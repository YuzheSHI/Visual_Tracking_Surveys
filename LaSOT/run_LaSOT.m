function run_LaSOT(data_path, trackers)
...
save_fig_path = '../vis_results/LaSOT/'; % path to result figures
...
sequences  = config_sequence(evaluation_dataset_type, data_path);
