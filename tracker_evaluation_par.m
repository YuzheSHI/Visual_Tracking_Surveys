...
% This script is the parallel version of tracker_evaluation.m
% to run the experiments in parallel, please make sure that
% your matlab is equipped with Parallel-Toolbox.
