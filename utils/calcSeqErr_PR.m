function [aveErrCoverage, aveErrCoverage_P, aveErrCoverage_R, aveErrCenter,errCoverage, errCoverage_P, errCoverage_R, errCenter] = calcSeqErr_PR(results, rect_anno)
...
[errCoverage, errCoverage_P, errCoverage_R] = calcRectInt_PR(rectMat(1:seq_length,:),rect_anno(1:seq_length,:));

aveErrCoverage = sum(errCoverage)/seq_length;
aveErrCoverage_P = sum(errCoverage_P)/seq_length;
aveErrCoverage_R = sum(errCoverage_R)/seq_length;
